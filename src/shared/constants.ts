...
export enum Application {
  ...
  TRAINING_AGE_DAMPING = 0.005,
  TRAINING_AGE_DAMPING_MULTIPLIER = 0.005,
  TRAINING_AGE_DAMPING_THRESHOLD = 25,
  TRAINING_AGE_DECAY_START = 35,
...
export enum CalendarEntry {
  ...
  TRANSFER_CONTRACT_EXPIRED = '/transfer/contract/expired',
  TRANSFER_CONTRACT_RENEW = '/transfer/contract/renew',
...
export enum IPCRoute {
  ...
  TRANSFER_RENEW_ACCEPT = '/transfer/renew/accept',
  TRANSFER_RENEW_REJECT = '/transfer/renew/reject',
...
export const PrizePool: Record<TierSlug | string, { total: number; distribution: Array<number> }> =
  {
    ...
    [TierSlug.CIRCUIT_PLAYOFFS]: { total: 150_000, distribution: [50, 35, 15] },
    ...
    [TierSlug.ESWC_PLAYOFFS]: { total: 1_500_000, distribution: [50, 35, 15] },
    [TierSlug.LEAGUE_OPEN]: { total: 5_000, distribution: [50, 35, 15] },
    [TierSlug.LEAGUE_OPEN_PLAYOFFS]: { total: 0, distribution: [] },
    [TierSlug.LEAGUE_CUP]: { total: 75_000, distribution: [75, 25] },
    ...
    [TierSlug.SPONSORS_BLUEQUIL]: { total: 250_000, distribution: [50, 35, 15] },
    [TierSlug.SPONSORS_HEAVENCASE]: { total: 100_000, distribution: [50, 35, 15] },
    [TierSlug.SPONSORS_NINEKBET]: { total: 100_000, distribution: [50, 35, 15] },
    [TierSlug.SPONSORS_SKINARCH]: { total: 50_000, distribution: [50, 35, 15] },
    [TierSlug.SPONSORS_WHITE_WOLF]: { total: 75_000, distribution: [50, 35, 15] },
  };
