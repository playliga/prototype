...
export const Items: Array<Item> = [
  ...
  // sponsor tournaments
  {
    tierSlug: Constants.TierSlug.SPONSORS_BLUEQUIL,
    on: Constants.CalendarEntry.SEASON_START,
    entries: [
      {
        action: Action.FALLBACK,
  ...
  {
    tierSlug: Constants.TierSlug.SPONSORS_HEAVENCASE,
    on: Constants.CalendarEntry.SEASON_START,
    entries: [
      {
        action: Action.FALLBACK,
  ...
  {
    tierSlug: Constants.TierSlug.SPONSORS_NINEKBET,
    on: Constants.CalendarEntry.SEASON_START,
    entries: [
      {
        action: Action.FALLBACK,
  ...
  {
    tierSlug: Constants.TierSlug.SPONSORS_WHITE_WOLF,
    on: Constants.CalendarEntry.SEASON_START,
    entries: [
      {
        action: Action.FALLBACK,
  ...
  {
    tierSlug: Constants.TierSlug.SPONSORS_SKINARCH,
    on: Constants.CalendarEntry.SEASON_START,
    entries: [
      {
        action: Action.FALLBACK,
