...
- added better team logos ([#70](https://github.com/lemonpole/liga-public/issues/70))
...
- [View the Blog post](https://github.com/lemonpole/liga-public/discussions/111)

### Features

- add competitions screen ([#82](https://github.com/lemonpole/liga-public/issues/82))
...
- [View the Blog post](https://github.com/lemonpole/liga-public/discussions/109)

### Features

- added discord server invite menu item ([discord.gg/ZaEwHfDD5N](https://discord.gg/ZaEwHfDD5N))
- added a match setup modal ([#80](https://github.com/lemonpole/liga-public/issues/80))
- added dark theme which can be set via the app settings ([#80](https://github.com/lemonpole/liga-public/issues/80))
- redesigned settings screen to be less confusing ([#80](https://github.com/lemonpole/liga-public/issues/80))

## 3.0.0-beta.10 (2024-10-16)

- [View the Blog post](https://github.com/lemonpole/liga-public/discussions/107)

### Features

- added ability to define custom launch options for cs:go ([#79](https://github.com/lemonpole/liga-public/issues/79))
- added ability for users to view their reported issues or feature requests
- earnings are now shown in the navbar ([#70](https://github.com/lemonpole/liga-public/issues/70))
- restore inventory customizations in cs:go ([#80](https://github.com/lemonpole/liga-public/issues/80))
- added menu item to view app changelog
- added a "What's New" modal and menu item

### Bug Fixes

- add warning modal if trying to close app while calendar is advancing. ([#77](https://github.com/lemonpole/liga-public/issues/77))
- fixed attack and reaction time stats not being trained
- fixed date of save showing incorrectly ([#81](https://github.com/lemonpole/liga-public/issues/81))
...
- fixed date of save showing incorrectly ([#81](https://github.com/lemonpole/liga-public/issues/81))
- fixed map override not being honored ([#84](https://github.com/lemonpole/liga-public/issues/84))
- properly honor starters selection ([#85](https://github.com/lemonpole/liga-public/issues/85))
...
- fix steam and game detection logic ([#73](https://github.com/lemonpole/liga-public/issues/73), [#76](https://github.com/lemonpole/liga-public/issues/76))
...
- [View the Blog post](https://github.com/lemonpole/liga-public/discussions/67)
...
- [View the Blog post](https://github.com/lemonpole/liga-public/discussions/66)
...
- clamp total xp to maximum achievable xp when training ([#45](https://github.com/lemonpole/liga-public/issues/45))
...
- prevent user from clicking on nav when the app is working ([#44](https://github.com/lemonpole/liga-public/issues/44))
- render welcome message when user joins a team
- sync training boost labels with stats in player card

## 3.0.0-beta.3 (2024-09-05)

- [View the Blog post](https://github.com/lemonpole/liga-public/discussions/43)
